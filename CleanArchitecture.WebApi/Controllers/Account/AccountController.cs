...
using CleanArchitecture.Application.Account.Queries.SunriseSunset;
...
namespace CleanArchitecture.WebApi.Controllers.Account
{
    ...
    public class AccountController : BaseController
    {
        ...
        [HttpPost]
        [AllowAnonymous]
        [Route("FindSunsetSunrise")]
        public async Task<IActionResult> SignUp([FromBody] SunriseSunsetQuery model)
        {
